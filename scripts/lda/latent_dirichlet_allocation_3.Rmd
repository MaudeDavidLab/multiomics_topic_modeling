...
getwd()
for(i in seq(1, 10)){
  getQuantileCorrelations(ps_16s_filt, "../../results/latent_variable_modeling/models/16s_models_50000/", title = "16s", sim = F, iteration = i)
}
...
for(i in seq(1, 3)){
  getQuantileCorrelations(ps_mtg_filt, "../../results/latent_variable_modeling/models/mtg_models_50000/sim/", title = "mtg", sim = F, iteration = i)
}
...
for(i in seq(1, 10)){
  getQuantileCorrelations(ps_mtt_filt, "../../results/latent_variable_modeling/models/mtt_models_50000/", title = "mtt", sim = F, iteration = i)
}
...
for(i in seq(1, 2)){
  getQuantileCorrelations(ps_mbx_filt, "../../results/latent_variable_modeling/models/mbx_models_50000/", title = "MBX", sim = F, iteration = i)
}
...
p_16s <- plotQuantileCorrelations ( "../../results/latent_variable_modeling/models/16s_models_50000/", title = "16s") 
p_mtg <- plotQuantileCorrelations ( "../../results/latent_variable_modeling/models/mtg_models_50000/", title = "mtg") 
p_mtt <- plotQuantileCorrelations ( "../../results/latent_variable_modeling/models/mtt_models_50000/", title = "mtt")  
p_mbx <- plotQuantileCorrelations ( "../../results/latent_variable_modeling/models/mbx_models_50000/", title = "MBX")
...
```{r}
control_variables <- c("whole_grain", "olive_oil", "fat_oil_freq",  "dairy", "dairy_freq", "fruit", "fruit_freq", "vegetable", "vegetable_freq", "fermented_vegetables", "meal_home_prep", "meal_ready_eat",  "restaurant", "meat", "seafood",  "sweetened_drink",  "sugary_food", "starchy_food",    "csection", "age")
...
meta <- read.csv("~/Lab/M3/data/all_meta_data.csv", row.names=1)
